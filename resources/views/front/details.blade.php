        ...
        <div class="bg-white flex flex-col gap-5 p-5 rounded-[20px]">
            ...
            <div class="flex flex-col gap-[6px] w-full">
                ...
                <div class="grid sm:grid-cols-4 gap-5">
                    ...
                    @empty
                        <p>Tools Belum di Definisikan</p>
                    @endforelse
            ...
            <div class="flex flex-col gap-3">
                ...
                @auth
                    @if (Auth::user()->hasAppliedToProject($project->id))
                        <a href="{{ route('dashboard.proposals') }}" class="bg-[#6635F1] p-[14px_20px] rounded-full font-semibold text-white text-center">View Proposals</a>
                    @else
                        @if (!$project->has_finished)
